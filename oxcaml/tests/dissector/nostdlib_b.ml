...
(* Many functions *)
let g00 x = x * 2 let g01 x = x * 3 let g02 x = x * 4 let g03 x = x * 5 let g04 x = x * 6
let g05 x = x * 7 let g06 x = x * 8 let g07 x = x * 9 let g08 x = x * 10 let g09 x = x * 11
let g10 x = x * 12 let g11 x = x * 13 let g12 x = x * 14 let g13 x = x * 15 let g14 x = x * 16
let g15 x = x * 17 let g16 x = x * 18 let g17 x = x * 19 let g18 x = x * 20 let g19 x = x * 21
let g20 x = x * 22 let g21 x = x * 23 let g22 x = x * 24 let g23 x = x * 25 let g24 x = x * 26
let g25 x = x * 27 let g26 x = x * 28 let g27 x = x * 29 let g28 x = x * 30 let g29 x = x * 31
let g30 x = x * 32 let g31 x = x * 33 let g32 x = x * 34 let g33 x = x * 35 let g34 x = x * 36
let g35 x = x * 37 let g36 x = x * 38 let g37 x = x * 39 let g38 x = x * 40 let g39 x = x * 41
let g40 x = x * 42 let g41 x = x * 43 let g42 x = x * 44 let g43 x = x * 45 let g44 x = x * 46
let g45 x = x * 47 let g46 x = x * 48 let g47 x = x * 49 let g48 x = x * 50 let g49 x = x * 51
