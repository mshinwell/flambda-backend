...
(** Print out a type.  This will pick names for type variables, and will not
    ...
    [prepared_type_expr].  *)
val type_expr: Format.formatter -> type_expr -> unit

(** Prints a modality. If it is the identity modality, prints [id], which
    defaults to nothing. *)
val modality :
  ?id:(Format.formatter -> unit) -> Format.formatter -> 'a Mode.Modality.Atom.t -> unit
...
val prepared_type_expr: Format.formatter -> type_expr -> unit
...
val constructor_arguments: Format.formatter -> constructor_arguments -> unit
val tree_of_type_scheme: type_expr -> Outcometree.out_type
val type_scheme: Format.formatter -> type_expr -> unit
val prepared_type_scheme: Format.formatter -> type_expr -> unit
val shared_type_scheme: Format.formatter -> type_expr -> unit
...
val tree_of_value_description: Ident.t -> value_description -> Outcometree.out_sig_item
val value_description: Ident.t -> Format.formatter -> value_description -> unit
val label : Format.formatter -> label_declaration -> unit
val add_constructor_to_preparation : constructor_declaration -> unit
val prepared_constructor : Format.formatter -> constructor_declaration -> unit
val constructor : Format.formatter -> constructor_declaration -> unit
...
val prepared_type_declaration: Ident.t -> Format.formatter -> type_declaration -> unit
val type_declaration: Ident.t -> Format.formatter -> type_declaration -> unit
val tree_of_extension_constructor:
    Ident.t -> extension_constructor -> ext_status -> Outcometree.out_sig_item
val add_extension_constructor_to_preparation :
    extension_constructor -> unit
val prepared_extension_constructor:
    Ident.t -> Format.formatter -> extension_constructor -> unit
...
val modtype: Format.formatter -> module_type -> unit
...
val tree_of_typexp: type_or_scheme -> type_expr -> Outcometree.out_type
val modtype_declaration: Ident.t -> Format.formatter -> modtype_declaration -> unit
val class_type: Format.formatter -> class_type -> unit
val tree_of_class_declaration:
    Ident.t -> class_declaration -> rec_status -> Outcometree.out_sig_item
val class_declaration: Ident.t -> Format.formatter -> class_declaration -> unit
val tree_of_cltype_declaration:
    Ident.t -> class_type_declaration -> rec_status -> Outcometree.out_sig_item
val cltype_declaration: Ident.t -> Format.formatter -> class_type_declaration -> unit
val type_expansion :
...
val report_ambiguous_type_error:
    ...
    (Format.formatter -> unit) -> (Format.formatter -> unit) -> (Format.formatter -> unit) -> unit
...
val print_items: (Env.t -> signature_item -> 'a option) ->
  Env.t -> signature_item list -> (Outcometree.out_sig_item * 'a option) list
...
val tree_of_module:
    Ident.t -> ?ellipsis:bool -> module_type -> rec_status -> Outcometree.out_sig_item
val modtype: Format.formatter -> module_type -> unit
val signature: Format.formatter -> signature -> unit
val tree_of_modtype: module_type -> Outcometree.out_module_type
val tree_of_modtype_declaration:
    Ident.t -> modtype_declaration -> Outcometree.out_sig_item
