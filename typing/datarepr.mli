...
val labels_of_type:
  ...
  (Ident.t * Types.label_description) list
val unboxed_labels_of_type:
  Path.t -> type_declaration ->
  (Ident.t * Types.unboxed_label_description) list
val constructors_of_type:
  current_unit:(Unit_info.t option) -> Path.t -> type_declaration ->
  (Ident.t * Types.constructor_description) list


exception Constr_not_found

val find_constr_by_tag:
  constant:bool -> int -> ((Types.constructor_description * 'a) * 'b) list ->
