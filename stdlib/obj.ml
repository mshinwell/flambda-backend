...
external repr_contended : 'a -> t = "%obj_magic"
external obj : t -> 'a = "%obj_magic"
external obj_contended : t -> 'a = "%obj_magic"
...
external opaque_identity_contended : 'a -> 'a = "%opaque"
...
external field_contended : t -> int -> t = "%obj_field"
...
external unsafe_get_int64_field : t -> int64# -> int64#
  = "%get_idx"
external unsafe_set_int64_field : t -> int64# -> int64# -> unit
  = "%set_idx"
external raw_field_bytecode : t -> int -> raw_data
  = "caml_obj_raw_field"
external set_raw_field_bytecode : t -> int -> raw_data -> unit
