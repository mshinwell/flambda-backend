...
external make: int -> 'a -> 'a array @@ portable = "caml_array_make"
external create: int -> 'a -> 'a array @@ portable = "caml_array_make"
...
external create_float: int -> float array @@ portable = "caml_array_create_float"
