...
let oper_result_type = function
  ...
  | Cbeginregion ->
    ...
    typ_int
  | Cendregion -> typ_void
  | Cbegin_uninterruptable -> typ_addr
  | Cend_uninterruptable -> typ_void
...
method is_simple_expr = function
  ...
  | Cop(op, args, _) ->
      ...
      | Cbegin_uninterruptable | Cend_uninterruptable ->
...
method effects_of exp =
  ...
  | Cop (op, args, _) ->
    let from_op =
      ...
      | Cbegin_uninterruptable | Cend_uninterruptable -> EC.arbitrary
...
method select_operation op args _dbg =
  ...
  | (Cbegin_uninterruptable, _) -> Ibegin_uninterruptable, []
  | (Cend_uninterruptable, _) -> Iend_uninterruptable, args
