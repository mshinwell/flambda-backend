...
let destroyed_at_oper = function
  ...
  | Iexit _ | Iraise _
  | Iop(Ibeginregion | Iendregion | Ibegin_uninterruptable
      | Iend_uninterruptable)
    ->
    if fp then
...
let safe_register_pressure = function
  ...
  | Ibeginregion | Iendregion | Ibegin_uninterruptable | Iend_uninterruptable
...
let max_register_pressure =
  ...
  | Iname_for_debugger _ | Iprobe _ | Iprobe_is_enabled _ | Iopaque
  | Ibeginregion | Iendregion | Ibegin_uninterruptable
  | Iend_uninterruptable
