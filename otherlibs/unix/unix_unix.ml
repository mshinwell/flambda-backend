...
external error_message :
  error -> string = "caml_unix_error_message"
...
external unsafe_getenv:
  string -> string = "caml_sys_unsafe_getenv"
...
external unsafe_write_bigarray :
  file_descr -> _ Bigarray.Array1.t -> int -> int -> single: bool
  -> int
...
external truncate :
  string -> int -> unit = "caml_unix_truncate"
...
external rename :
  string -> string -> unit = "caml_unix_rename"
external link :
  ?follow:bool -> string -> string -> unit
  = "caml_unix_link"
...
module LargeFile =
  struct
    external lseek : file_descr -> int64 -> seek_command -> int64 = "caml_unix_lseek_64"
    external truncate :
      string -> int64 -> unit = "caml_unix_truncate_64"
    external ftruncate :
      file_descr -> int64 -> unit = "caml_unix_ftruncate_64"
    type stats =
      { st_dev : int;
        st_ino : int;
        st_kind : file_kind;
...
external chmod :
  string -> file_perm -> unit = "caml_unix_chmod"
external fchmod : file_descr -> file_perm -> unit = "caml_unix_fchmod"
external chown :
  string -> int -> int -> unit = "caml_unix_chown"
...
external dup :
  ...
  = "caml_unix_dup"
external dup2 :
  ?cloexec: bool -> file_descr -> file_descr -> unit
  = "caml_unix_dup2"
...
external mkdir :
  string -> file_perm -> unit = "caml_unix_mkdir"
...
external opendir :
  string -> dir_handle = "caml_unix_opendir"
external readdir :
  dir_handle -> string = "caml_unix_readdir"
external rewinddir :
  dir_handle -> unit = "caml_unix_rewinddir"
external closedir :
  dir_handle -> unit = "caml_unix_closedir"

(* Pipes *)

external pipe :
  ?cloexec: bool -> unit -> file_descr * file_descr
  = "caml_unix_pipe"
external mkfifo :
  string -> file_perm -> unit = "caml_unix_mkfifo"

(* Symbolic links *)

external readlink : string -> string = "caml_unix_readlink"
external symlink :
  ?to_dir:bool -> string -> string -> unit
  = "caml_unix_symlink"
...
external getitimer:
  ...
  = "caml_unix_getitimer"
external setitimer:
  interval_timer -> interval_timer_status -> interval_timer_status = "caml_unix_setitimer"
...
external setgroups :
  int array -> unit = "caml_unix_setgroups"
external initgroups :
  string -> int -> unit = "caml_unix_initgroups"
...
external getpwnam :
  string -> passwd_entry = "caml_unix_getpwnam"
external getgrnam :
  string -> group_entry = "caml_unix_getgrnam"
...
external socket :
  ?cloexec: bool -> socket_domain -> socket_type -> int -> file_descr = "caml_unix_socket"
external socketpair :
...
external accept :
  ...
  = "caml_unix_accept"
external bind :
  file_descr -> sockaddr -> unit = "caml_unix_bind"
external connect :
  file_descr -> sockaddr -> unit = "caml_unix_connect"
...
external unsafe_recv :
  file_descr -> bytes -> int -> int -> msg_flag list -> int = "caml_unix_recv"
external unsafe_recvfrom :
  file_descr -> bytes -> int -> int -> msg_flag list ->
  int * sockaddr = "caml_unix_recvfrom"
...
external gethostbyname :
  string -> host_entry = "caml_unix_gethostbyname"
external gethostbyaddr :
  inet_addr -> host_entry = "caml_unix_gethostbyaddr"
external getprotobyname :
  string -> protocol_entry = "caml_unix_getprotobyname"
...
external getaddrinfo_system :
  ...
  addr_info list = "caml_unix_getaddrinfo"
...
let allow_thread_unsafe_emulation =
  let open struct
    ...
    external domain_id :
      unit -> int = "caml_ml_domain_id" [@@noalloc]
  end in
...
external spawn :
  string -> string array ->
  string array option -> bool -> int array -> int = "caml_unix_spawn"
