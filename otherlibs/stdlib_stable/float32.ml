...
module Bytes = struct
  ...
  external unsafe_get : bytes -> pos:int -> float32
    = "%caml_bytes_getf32u"
  external set : bytes -> pos:int -> float32 -> unit
    = "%caml_bytes_setf32"
...
module String = struct
  external get : string -> pos:int -> float32
    = "%caml_string_getf32"
  external unsafe_get : string -> pos:int -> float32
    = "%caml_string_getf32u"
end
...
module Bigstring = struct
  ...
  external unsafe_get : t -> pos:int -> float32
    = "%caml_bigstring_getf32u"
  external set : t -> pos:int -> float32 -> unit
...
module Bigarray = struct
  ...
  module Array1 = struct
    external get :
      ('a, float32_elt, 'c) Array1.t -> int -> float32
