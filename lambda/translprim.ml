...
let specialize_primitive env loc ty ~has_constant_constructor prim =
  ...
  | Primitive
      (Parrayrefs (Punboxedint64array_reinterpret_ref [], index_kind, mut),
        2),
      [_array_ty; _index_ty] ->
    let result_ty =
    ...
    in
    Some (Primitive
      (Parrayrefs (Punboxedint64array_reinterpret_ref kinds, index_kind, mut),
        2))
  | Primitive
    ...
    Some (Primitive
      (Parraysets (Punboxedint64array_reinterpret_set kinds, index_kind),
        3))
  | Primitive
      (Parrayrefu (Punboxedint64array_reinterpret_ref [], index_kind, mut),
        2),
      [_array_ty; _index_ty] ->
    let result_ty =
      match result_ty with
    ...
    in
    Some (Primitive
      (Parrayrefu (Punboxedint64array_reinterpret_ref kinds, index_kind, mut),
        2))
  | Primitive
    ...
    Some (Primitive
      (Parraysetu (Punboxedint64array_reinterpret_set kinds, index_kind),
        3))
  | Primitive
      ((Parrayrefs (Punboxedint64array_reinterpret_ref _, _, _)
       | Parraysets (Punboxedint64array_reinterpret_set _, _)
       | Parrayrefu (Punboxedint64array_reinterpret_ref _, _, _)
