                                       ...
                                       mlsize_t mem)
{
  ...
  uintnat custom_minor_max_bsz = atomic_load_relaxed(&caml_custom_minor_max_bsz);
  if (custom_minor_max_bsz > 100) {
    max_minor_single = custom_minor_max_bsz;
  } else {
    max_minor_single = max_minor * custom_minor_max_bsz / 100;
  }
