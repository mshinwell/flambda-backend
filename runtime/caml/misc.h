...
/* Per-slice events / "Growing and shrinking of the heap" */
#define CAML_GC_MSG_SLICE           0x00004
#define CAML_GC_MSG_HEAPSIZE        0x00004
/* Heap compaction / "Resizing of stacks and memory manager tables" */
#define CAML_GC_MSG_COMPACT         0x00008
#define CAML_GC_MSG_STACKSIZE       0x00008
...
/* Major domain events (such as creation and termination) / "Computation of major GC slice size" */
#define CAML_GC_MSG_DOMAIN          0x00040
#define CAML_GC_MSG_SLICESIZE       0x00040
/* Stop-the-world events / "Calling of finalization functions" */
#define CAML_GC_MSG_STW             0x00080
#define CAML_GC_MSG_FINALIZE        0x00080
/* Minor heap events (such as creation and resizing) / "Startup messages" */
#define CAML_GC_MSG_MINOR_HEAP      0x00100
#define CAML_GC_MSG_STARTUP         0x00100
/* Major heap events (such as creation and teardown) / "Computation of compaction-triggering condition" */
#define CAML_GC_MSG_MAJOR_HEAP      0x00200
#define CAML_GC_MSG_COMPACT_TRIGGER 0x00200
/* Resizing of GC tables / "Output GC statistics at program exit" */
#define CAML_GC_MSG_TABLES          0x00400
#define CAML_GC_MSG_STATS           0x00400
/* Allocation and resizing of stacks / "GC debugging messages" */
#define CAML_GC_MSG_STACKS          0x00800
#define CAML_GC_MSG_DEBUG           0x00800
