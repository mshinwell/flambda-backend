...
val create : Downwards_env.t -> Continuation_uses_env.t -> Closure_offsets.t Or_unknown.t -> t
...
val with_closure_offsets : t -> closure_offsets:Closure_offsets.t Or_unknown.t -> t
