...
let array_load ~dbg (array_kind : P.Array_kind.t)
  ...
  | (Naked_int64s | Naked_nativeints), (Naked_int64s | Naked_nativeints) ->
    C.unboxed_int64_or_nativeint_array_ref ~has_custom_ops:true arr index dbg
  | Unboxed_product _, (Naked_int64s | Naked_nativeints) ->
    C.unboxed_int64_or_nativeint_array_ref ~has_custom_ops:false arr index dbg
  ...
  | Unboxed_product _, Naked_float32s ->
    C.unboxed_mutable_float32_unboxed_product_array_ref arr index dbg
  | Naked_int32s, Naked_int32s -> C.unboxed_int32_array_ref arr index dbg
  | Unboxed_product _, Naked_int32s ->
    C.unboxed_mutable_int32_unboxed_product_array_ref arr index dbg
...
let array_set0 ~dbg (array_kind : P.Array_kind.t)
  ...
  | Unboxed_product _, Naked_float32s ->
    C.unboxed_mutable_float32_unboxed_product_array_set arr ~index ~new_value
      dbg
  | Naked_int32s, Naked_int32s ->
    C.unboxed_int32_array_set arr ~index ~new_value dbg
  | Unboxed_product _, Naked_int32s ->
    C.unboxed_mutable_int32_unboxed_product_array_set arr ~index ~new_value dbg
  | (Immediates | Naked_floats), Naked_vec128s ->
