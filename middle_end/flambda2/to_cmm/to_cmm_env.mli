...
(** Retrieve the [Exported_code.t] (i.e., functions_info) as passed to
    [create]. Used by [To_cmm_code_blocks] to compute dependency lists when
    emitting [Code_block]s for unloadable functions. *)
