...
module Cmm_helpers = struct
  ...
  module Extended_machtype_component = Cmm_helpers.Extended_machtype_component
  module Extended_machtype = Cmm_helpers.Extended_machtype
...
let invalid res ~message =
  ...
  let message_sym, res =
    ...
    | None ->
      let message_sym =
        Flambda2_identifiers.Symbol.create
