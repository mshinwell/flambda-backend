...
let add_closure_id t clos_id name_mode =
  { t with closure_ids = For_closure_ids.add t.closure_ids clos_id name_mode }

let add_closure_var t clos_var name_mode =
  { t with
    closure_vars = For_closure_vars.add t.closure_vars clos_var name_mode
  }
