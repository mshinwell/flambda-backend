...
let nullary_primitive_eligible_for_cse = function
  | Invalid _ | Optimised_out _ | Probe_is_enabled _ | Begin_region _ -> false
...
let compare_nullary_primitive p1 p2 =
  ...
  | Invalid _, (Optimised_out _ | Probe_is_enabled _ | Begin_region _) -> -1
...
let nullary_classify_for_printing p =
  match p with
  | Invalid _ | Optimised_out _ | Probe_is_enabled _ | Begin_region _ -> Neither
