...
and let_symbol_exprs env
    ((bound_static1 : Bound_pattern.symbols), static_consts1, body1)
    ((bound_static2 : Bound_pattern.symbols), static_consts2, body2) :
    Expr.t Comparison.t =
  let ok = ref true in
  let bound_static1 = bound_static1.bound_static in
  let bound_static2 = bound_static2.bound_static in
  ...
  then Equivalent
    ...
    let approximant =
      Let.create
        (Bound_pattern.symbols bound_static1')
